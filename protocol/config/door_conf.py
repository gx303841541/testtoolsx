...
Attribute_initialization = {
    "mac_list": [
        '58:FC:DB:DA:' + re.sub(r'^(?P<xx>\d\d)', "\g<xx>:", str(i))
...
Command_list = {
    ...
    "COM_DELETE_CERTIFICATE_IN_BATCH": {
        "msg": "清除固定凭证操作"
    },
    "COM_GATE_CONTROL": {
        "msg": "开关闸（门）"
...
COM_SETTING_PARAMETERS = {
    "set_item": {
        ...
        "_alarmTimeout": "Data.alarmTimeout",
        "_openDuration": "Data.openDuration"
    },
    "rsp_msg": {
...
COM_LOAD_CERTIFICATE = {
    "set_item": {
        "_startTime": "Data.0.startTime",
        "_endTime": "Data.0.endTime",
        "_subDeviceID": "Data.0.subDeviceID",
        "_UserType": "Data.0.UserType",
        "_CredenceType": "Data.0.CredenceType",
        "_credenceNo": "Data.0.credenceNo",
